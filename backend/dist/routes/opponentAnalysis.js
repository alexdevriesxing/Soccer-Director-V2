...
router.get('/fixtures/:id/pre-match-report', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.get('/clubs/:id/opponent-analysis', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    return res.status(410).json({
        error: 'Deprecated endpoint',
