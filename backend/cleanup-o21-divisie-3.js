...
async function cleanupO21Divisie3() {
  try {
    console.log('Cleaning up O21 Divisie 3 - moving existing clubs to Deleted Clubs league...');
    ...
    // Get all clubs in O21 Divisie 3
    ...
    console.log('\nCleanup complete! All existing O21 Divisie 3 clubs moved to Deleted Clubs.');

  } catch (error) {
    console.error('Error cleaning up O21 Divisie 3:', error);
  } finally {
